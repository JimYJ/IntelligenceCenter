...
type Task struct {
	...
	TaskStatus          bool     `json:"task_status" db:"task_status"`                     // 任务状态 0关闭 1启用
	EnableFilter        bool     `json:"enable_filter" db:"enable_filter"`                 // 启用匹配过滤器 0关闭 1启用
	...
	CrawlOption         bool     `json:"crawl_option,string" db:"crawl_option"`            // 抓取器设置 0自定义 1全局
